...
If you want to help by providing a translation of content/rules in the language you know, submit a pull request (or DM (original repo owner) on Twitter @ka11away), adding a sub-folder in the 'intl' folder with the files of the translation there.
...
10.  If you find a great, helpful resource that others would benefit from, either submit a Pull Request to add it to the repo, or just tweet at (original repo owner) (see info below)
...
* If you have any questions or ideas about 100DaysOfCode (or other ideas), feel free to reach out to (original repo owner) on Twitter: [@ka11away](https://twitter.com/ka11away)
